...
.I7OXgf.ZEeHrd, .NZ9wdc, .i5sehe, .kox42c {
    ...
    window.darkcsselem = document.createElement('style');
    window.darkcsselem.type = 'text/css';
    window.darkcsselem.innerText = style;
    function change() {
        if(window.matchMedia('(prefers-color-scheme: dark)').matches) {
            document.head.appendChild(window.darkcsselem);
        } else {
            window.darkcsselem.remove();
        }
    }
    
    // Run check on load/dark mode change
